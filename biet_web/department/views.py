...
def home(request, course, dept):
    ...
    if course == 'UG' and dept == 'CV':
        ...
        faculties_data = mca_dept.objects.all().order_by('sno')
        ...
        learning_materials_data = mca_dept_learning_materials.objects.all().order_by('semester', 'subject_code')

        events = mca_dept_events.objects.all()
        classrooms = mca_dept_classroom.objects.all()
        classrooms_desc = mca_dept_classroom_description.objects.all()
        ...
        grants_patents_data = mca_dept_grants_and_patents.objects.all()
        accreditation_data = mca_dept_accreditation.objects.all().order_by('sno')
        alumni_data = mca_dept_alumni.objects.all().order_by('sno')
        placement_data = mca_dept_placement.objects.all().order_by('sno')
        ...
        faculties_data = environmental_dept.objects.all().order_by('sno')
        ...
        learning_materials_data = environmental_dept_learning_materials.objects.all().order_by('semester', 'subject_code')

        events = environmental_dept_events.objects.all()
        classrooms = environmental_dept_classroom.objects.all()
        classrooms_desc = environmental_dept_classroom_description.objects.all()
        ...
        grants_patents_data = environmental_dept_grants_and_patents.objects.all()
        accreditation_data = environmental_dept_accreditation.objects.all().order_by('sno')
        alumni_data = environmental_dept_alumni.objects.all().order_by('sno')
        placement_data = environmental_dept_placement.objects.all().order_by('sno')
